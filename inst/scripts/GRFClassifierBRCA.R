...
#
results <-
    base::readRDS(file = "inst/extdata/GRFClassifierBRCA.rds")
...
ggplot2::ggsave("inst/extdata/BRCAGRF.png", plot = ggplot2::last_plot(),
...
ggplot2::ggsave("inst/extdata/BRCAROC.png", plot = ggplot2::last_plot(),
                device = "png", width = 7, height = 7)
