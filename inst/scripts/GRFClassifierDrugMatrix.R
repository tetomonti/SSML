...
#
results <-
    base::readRDS(file = "inst/extdata/GRFClassifierDrugMatrix.rds")
...
ggplot2::ggsave("inst/extdata/DrugMatrixGRF.png", plot = ggplot2::last_plot(),
...
ggplot2::ggsave("inst/extdata/DrugMatrixROC.png", plot = ggplot2::last_plot(),
                device = "png", width = 7, height = 7)
